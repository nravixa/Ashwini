      ...
      >
        ...
        >
          ...
          <Link
            ...
            className="brand-bold text-sm sm:text-base md:text-lg tracking-[0.12em] sm:tracking-[0.15em] text-white uppercase shrink-0"
          >
            ASHWINI SALON
          </Link>
        ...
        >
          ...
          <div className="relative w-full flex items-center justify-center pb-6 border-b border-white/10 shrink-0">
            <span className="brand-bold text-sm sm:text-base tracking-[0.12em] sm:tracking-[0.15em] text-white uppercase text-center">
              ASHWINI SALON
            </span>
            <button
